...
const QRgen = ({ navigation }) => {
  ...
  return (
    <View
      ...
      <Text style={{marginTop:30, marginBottom: 10}}>전송받을 코인의 갯수를 입력하세요.</Text>
      <TextInput
      ...
      {address ? <QRCode value={address + "|" + text} size={200}></QRCode> : null}
      <Text style={{marginTop:10}}>전송받을 코인의 갯수가 {text}개 입니다.</Text>
